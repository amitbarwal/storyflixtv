...
export default function TermsPage() {
    return (
        <div className="min-h-screen bg-zinc-950 text-gray-300 py-8 md:py-16 px-4 md:px-6">
            <div className="max-w-4xl mx-auto space-y-12">

                {/* Header */}
                <div className="text-center space-y-4 border-b border-white/10 pb-12">
                    <h1 className="text-2xl md:text-4xl font-bold text-white tracking-tight">Terms of Service</h1>

                </div>

                {/* content */}
                <article className="prose prose-sm md:prose-lg prose-invert max-w-none space-y-12">

                    <section>
                        <h2 className="text-xl md:text-3xl font-bold text-white mb-4">1. Introduction</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl md:text-3xl font-bold text-white mb-4">2. User Eligibility</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl md:text-3xl font-bold text-white mb-4">3. Content Usage Rules</h2>
                    ...
                    <section>
                        <h2 className="text-xl md:text-3xl font-bold text-white mb-4">4. Subscriptions & Payments</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl md:text-3xl font-bold text-white mb-4">5. Disclaimer of Warranties</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl md:text-3xl font-bold text-white mb-4">6. Limitation of Liability</h2>
                        <p>
                    ...
                    <section className="bg-white/5 p-6 md:p-8 rounded-2xl border border-white/10">
                        <h2 className="text-xl md:text-3xl font-bold text-white mb-4">Contact Us</h2>
                        <p className="mb-4">
