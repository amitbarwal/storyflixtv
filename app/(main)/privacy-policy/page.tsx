...
export const metadata: Metadata = {
    ...
    description: "Read the Privacy Policy for StoryFlix TV to understand how we collect, use, and protect your data.",
};
...
export default function PrivacyPolicyPage() {
    return (
        <div className="min-h-screen pb-20 pt-20">
            {/* Header */}
            <section className="relative py-12 md:py-16 px-4 md:px-6 border-b border-white/5 bg-white/5">
            ...
            <div className="max-w-4xl mx-auto px-4 md:px-6 py-12 space-y-12">
                ...
                <section className="space-y-4">
                    <p className="text-sm md:text-lg text-gray-300 leading-relaxed">
                        At StoryFlix TV, accessible from storyflixtv.com, one of our main priorities is the privacy of our visitors.
                        This Privacy Policy document contains types of information that is collected and recorded by StoryFlix TV and how we use it.
                    </p>
                ...
                <section className="glass-card p-8 rounded-2xl border border-white/5 space-y-6">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h2 className="text-xl md:text-3xl font-bold">Information We Collect</h2>
                    </div>
                ...
                <section className="glass-card p-8 rounded-2xl border border-white/5 space-y-6">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h2 className="text-xl md:text-3xl font-bold">How We Use Your Information</h2>
                    </div>
                    <p className="text-sm md:text-base text-gray-300">We use the information we collect in various ways, including to:</p>
                    <ul className="grid sm:grid-cols-2 gap-4">
                        {[
                            ...
                            <li key={i} className="flex items-center gap-2 text-gray-400 text-sm md:text-base">
                ...
                <section className="glass-card p-8 rounded-2xl border border-white/5 space-y-6">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h2 className="text-xl md:text-3xl font-bold">Cookies and Web Beacons</h2>
                    </div>
                ...
                <section className="glass-card p-8 rounded-2xl border border-white/5 space-y-6">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h2 className="text-xl md:text-3xl font-bold">Your Data Protection Rights</h2>
                    </div>
                    ...
                    <div className="grid gap-4">
                        {[
                            ...
                            <div key={i} className="border-l-2 border-blue-500 pl-4 py-1">
                                ...
                                <p className="text-xs md:text-sm text-gray-400">{right.desc}</p>
                            </div>
                        ))}
                    </div>
                </section>
