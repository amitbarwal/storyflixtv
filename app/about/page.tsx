    ...
    return (
        <div className="min-h-screen pb-20">
            ...
            <section className="relative py-8 md:py-16 px-4 md:px-6 overflow-hidden">
                ...
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[300px] md:w-[600px] h-[300px] md:h-[600px] bg-indigo-600/20 rounded-full blur-[80px] md:blur-[120px] -z-10" />
            ...
            <section className="max-w-7xl mx-auto px-4 md:px-6">
                <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center mb-10 md:mb-16">
                    <div className="space-y-6">
                        <h2 className="text-xl md:text-3xl font-bold mb-4">Who We Are</h2>
                ...
                <div className="grid md:grid-cols-3 gap-4 md:gap-6 mb-10 md:mb-16">
                    <div className="glass-card p-6 md:p-8 rounded-2xl border border-white/5 hover:border-indigo-500/30 transition-colors">
                        <div className="w-12 h-12 bg-indigo-500/20 rounded-lg flex items-center justify-center mb-6">
                            <Film className="w-6 h-6 text-indigo-400" />
                        </div>
                        <h3 className="text-lg md:text-2xl font-bold mb-3">Short Movies</h3>
                    ...
                    <div className="glass-card p-6 md:p-8 rounded-2xl border border-white/5 hover:border-indigo-500/30 transition-colors">
                        ...
                        <h3 className="text-lg md:text-2xl font-bold mb-3">Web Series</h3>
                        <p className="text-sm md:text-base text-gray-400">
                    ...
                    <div className="glass-card p-6 md:p-8 rounded-2xl border border-white/5 hover:border-indigo-500/30 transition-colors">
                        ...
                        <h3 className="text-lg md:text-2xl font-bold mb-3">Curated Reels</h3>
                        <p className="text-sm md:text-base text-gray-400">
                ...
                {/* Mission Statement */}
                <div className="text-center max-w-3xl mx-auto glass-card p-6 md:p-12 rounded-3xl border border-white/10 relative overflow-hidden">
