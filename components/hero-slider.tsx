                    ...
                    >
                        ...
                        <div className="relative h-full w-full">
                            <Image
                                ...
                                alt={movie.title}
                                fill
                                className={`object-cover object-center transition-transform duration-[10000ms] ease-linear ${index === currentIndex ? 'scale-110' : 'scale-100'
                                    }`}
                                priority={index === 0}
                            />
                            {/* Overlay Gradients */}
                        ...
                        <div className="absolute inset-0 z-20 flex flex-col justify-center px-6 md:px-12 lg:px-24">
                            <div className={`max-w-2xl space-y-4 md:space-y-6 transform transition-all duration-1000 ${index === currentIndex ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
                                }`}>
                                {/* Badge */}
